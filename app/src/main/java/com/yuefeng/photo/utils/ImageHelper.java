...
public class ImageHelper {
    ...
    public static String getimage(Context context, String srcPath, String txt) {
        ...
        if (string.equals(context.getResources().getString(R.string.fengrun))) {
            bitmap = ImageUtils.drawTextToCenter(MyApplication.getContext(), bitmap, string, 22, Color.LTGRAY);
        } else {
            if (!TextUtils.isEmpty(txt)) {
                bitmap = ImageUtils.drawTextToCenter(MyApplication.getContext(), bitmap, txt, 22, Color.LTGRAY);
                bitmap = ImageUtils.drawTextToLeftBottom(MyApplication.getContext(), bitmap, TimeUtils.getCurrentTime(), 22, Color.LTGRAY, 0, 100);
            } else {
