...
/*注册融云通讯录*/
public class OrganPersonalRongBean implements Serializable {
    ...
    private String msg;
    private String text;
    private OrganPersonalRongDataBean data;
    ...
    public OrganPersonalRongDataBean getData() {
        return data;
    }

    public void setData(OrganPersonalRongDataBean data) {
        this.data = data;
    }
