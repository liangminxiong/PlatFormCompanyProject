...
public class OrganPersonalDataBean implements Serializable {
    /**
     * id : dg1168
     * pid :
     * name :
    ...
    private List<OrganlistBean> userlist;
    ...
    public void setOrganlist(List<OrganlistBean> organlist) {
        this.organlist = organlist;
    }

    public List<OrganlistBean> getUserlist() {
        return userlist;
    }

    public void setUserlist(List<OrganlistBean> userlist) {
