...
/*通讯录*/
public class SortBookAdapter extends BaseAdapter implements Filterable {
    ...
    private void initDate() {
        for (int i = 0; i < list.size(); i++) {
            getIsSelected().put(list.get(i).getUserId(), false);
        }
    }
    ...
    public View getView(final int position, View view, ViewGroup parent) {
        ...
        Boolean aBoolean = getIsSelected().get(userId);
        viewHolder.cb_tiem.setChecked(aBoolean);
