...
public class FartherFindOrganPresenter extends BasePresenterImpl<FindOrganUserContract.View,
        FartherGroupNameActivity> implements FindOrganUserContract.Presenter {
    public FartherFindOrganPresenter(FindOrganUserContract.View view, FartherGroupNameActivity activity) {
        super(view, activity);
    }
