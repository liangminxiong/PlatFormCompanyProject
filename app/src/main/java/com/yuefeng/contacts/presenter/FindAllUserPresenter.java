...
public class FindAllUserPresenter extends BasePresenterImpl<FindAllUserContract.View,
        GreateGroupChatActivity> implements FindAllUserContract.Presenter {
    public FindAllUserPresenter(FindAllUserContract.View view, GreateGroupChatActivity activity) {
        super(view, activity);
    }
