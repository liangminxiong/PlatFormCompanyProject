...
import com.yuefeng.contacts.ui.activity.FifthGroupNameActivity;
...
public class FifthFindOrganPresenter extends BasePresenterImpl<FindOrganUserContract.View,
        FifthGroupNameActivity> implements FindOrganUserContract.Presenter {
    public FifthFindOrganPresenter(FindOrganUserContract.View view, FifthGroupNameActivity activity) {
        super(view, activity);
    }
