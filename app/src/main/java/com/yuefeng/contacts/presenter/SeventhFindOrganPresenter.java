...
import com.yuefeng.contacts.ui.activity.SeventhGroupNameActivity;
...
public class SeventhFindOrganPresenter extends BasePresenterImpl<FindOrganUserContract.View,
        SeventhGroupNameActivity> implements FindOrganUserContract.Presenter {
    public SeventhFindOrganPresenter(FindOrganUserContract.View view, SeventhGroupNameActivity activity) {
        super(view, activity);
    }
