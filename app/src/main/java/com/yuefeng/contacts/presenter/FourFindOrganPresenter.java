...
import com.yuefeng.contacts.ui.activity.FourGroupNameActivity;
...
public class FourFindOrganPresenter extends BasePresenterImpl<FindOrganUserContract.View,
        FourGroupNameActivity> implements FindOrganUserContract.Presenter {
    public FourFindOrganPresenter(FindOrganUserContract.View view, FourGroupNameActivity activity) {
        super(view, activity);
    }
