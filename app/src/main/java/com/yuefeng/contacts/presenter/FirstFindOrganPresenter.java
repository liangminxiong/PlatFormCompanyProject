...
public class FirstFindOrganPresenter extends BasePresenterImpl<FindOrganUserContract.View,
        FirstGroupNameActivity> implements FindOrganUserContract.Presenter {
    public FirstFindOrganPresenter(FindOrganUserContract.View view, FirstGroupNameActivity activity) {
        super(view, activity);
    }
