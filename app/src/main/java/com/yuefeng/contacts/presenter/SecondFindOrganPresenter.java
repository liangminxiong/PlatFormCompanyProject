...
import com.yuefeng.contacts.ui.activity.SecondGroupNameActivity;
...
public class SecondFindOrganPresenter extends BasePresenterImpl<FindOrganUserContract.View,
        SecondGroupNameActivity> implements FindOrganUserContract.Presenter {
    public SecondFindOrganPresenter(FindOrganUserContract.View view, SecondGroupNameActivity activity) {
        super(view, activity);
    }
