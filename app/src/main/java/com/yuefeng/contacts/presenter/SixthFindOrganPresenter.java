...
import com.yuefeng.contacts.ui.activity.SixthGroupNameActivity;
...
public class SixthFindOrganPresenter extends BasePresenterImpl<FindOrganUserContract.View,
        SixthGroupNameActivity> implements FindOrganUserContract.Presenter {
    public SixthFindOrganPresenter(FindOrganUserContract.View view, SixthGroupNameActivity activity) {
        super(view, activity);
    }
