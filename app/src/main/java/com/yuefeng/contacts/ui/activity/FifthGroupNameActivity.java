...
import com.yuefeng.contacts.presenter.FifthFindOrganPresenter;
...
/*三级组*/
public class FifthGroupNameActivity extends BaseActivity implements FindOrganUserContract.View {
    //List<OrganlistBean>
    ...
    private FifthFindOrganPresenter mPresenter;
    ...
    protected void initView(Bundle savedInstanceState) {
        if (!EventBus.getDefault().isRegistered(this)) {
            ...
            mPresenter = new FifthFindOrganPresenter(this, this);
            initRecyclerView();
    ...
    private void toUserDetailActivity(String id) {
        ...
        intent.setClass(FifthGroupNameActivity.this, UserDetailInfosActivity.class);
    ...
    private void toActivity(OrganPersonalDataBean bean) {
        ...
        if (bean != null) {
            ...
            if (sizeOrgan > 0) {
                ...
                intent.setClass(FifthGroupNameActivity.this, SixthGroupNameActivity.class);
            } else {
                if (sizeUser > 0) {
                    intent.setClass(FifthGroupNameActivity.this, SelectPersonalWhoActivity.class);
                }
            }
            if (sizeUser > 0) {
