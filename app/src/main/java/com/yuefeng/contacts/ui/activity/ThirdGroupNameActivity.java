...
import com.yuefeng.contacts.presenter.ThirdFindOrganPresenter;
...
/*三级组*/
public class ThirdGroupNameActivity extends BaseActivity implements FindOrganUserContract.View {
    //List<OrganlistBean>
    ...
    private ThirdFindOrganPresenter mPresenter;
    ...
    protected void initView(Bundle savedInstanceState) {
        if (!EventBus.getDefault().isRegistered(this)) {
            ...
            mPresenter = new ThirdFindOrganPresenter(this, this);
            initRecyclerView();
    ...
    private void toUserDetailActivity(String id) {
        ...
        intent.setClass(ThirdGroupNameActivity.this, UserDetailInfosActivity.class);
    ...
    private void toActivity(OrganPersonalDataBean bean) {
        ...
        if (bean != null) {
            ...
            if (sizeOrgan > 0) {
                ...
                intent.setClass(ThirdGroupNameActivity.this, FourGroupNameActivity.class);
            } else {
                if (sizeUser > 0) {
                    intent.setClass(ThirdGroupNameActivity.this, SelectPersonalWhoActivity.class);
                }
            }
            if (sizeUser > 0) {
