...
import com.yuefeng.contacts.presenter.SixthFindOrganPresenter;
...
/*六级组*/
public class SixthGroupNameActivity extends BaseActivity implements FindOrganUserContract.View {
    //List<OrganlistBean>
    ...
    private SixthFindOrganPresenter mPresenter;
    ...
    protected void initView(Bundle savedInstanceState) {
        if (!EventBus.getDefault().isRegistered(this)) {
            ...
            mPresenter = new SixthFindOrganPresenter(this, this);
            initRecyclerView();
    ...
    private void toUserDetailActivity(String id) {
        ...
        intent.setClass(SixthGroupNameActivity.this, UserDetailInfosActivity.class);
    ...
    private void toActivity(OrganPersonalDataBean bean) {
        ...
        if (bean != null) {
            ...
            if (sizeOrgan > 0) {
                ...
                intent.setClass(SixthGroupNameActivity.this, SeventhGroupNameActivity.class);
            } else {
                if (sizeUser > 0) {
                    intent.setClass(SixthGroupNameActivity.this, SelectPersonalWhoActivity.class);
                }
            }
            if (sizeUser > 0) {
