...
import com.yuefeng.contacts.presenter.FourFindOrganPresenter;
...
/*三级组*/
public class FourGroupNameActivity extends BaseActivity implements FindOrganUserContract.View {
    //List<OrganlistBean>
    ...
    private FourFindOrganPresenter mPresenter;
    ...
    protected void initView(Bundle savedInstanceState) {
        if (!EventBus.getDefault().isRegistered(this)) {
            ...
            mPresenter = new FourFindOrganPresenter(this, this);
            initRecyclerView();
    ...
    private void toUserDetailActivity(String id) {
        ...
        intent.setClass(FourGroupNameActivity.this, UserDetailInfosActivity.class);
    ...
    private void toActivity(OrganPersonalDataBean bean) {
        ...
        if (bean != null) {
            ...
            if (sizeOrgan > 0) {
                ...
                intent.setClass(FourGroupNameActivity.this, FifthGroupNameActivity.class);
            } else {
                if (sizeUser > 0) {
                    intent.setClass(FourGroupNameActivity.this, SelectPersonalWhoActivity.class);
                }
            }
            if (sizeUser > 0) {
