...
import com.yuefeng.contacts.presenter.FirstFindOrganPresenter;
...
/*二级组*/
public class FirstGroupNameActivity extends BaseActivity implements FindOrganUserContract.View {
    //List<OrganlistBean>
    ...
    private FirstFindOrganPresenter mPresenter;
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        mPresenter = new FirstFindOrganPresenter(this, this);
        initRecyclerView();
    ...
    private void toUserDetailActivity(String id) {
        ...
        intent.setClass(FirstGroupNameActivity.this, UserDetailInfosActivity.class);
    ...
    private void toActivity(OrganPersonalDataBean bean) {
        ...
        if (bean != null) {
            ...
            if (sizeOrgan > 0) {
                ...
                intent.setClass(FirstGroupNameActivity.this, SecondGroupNameActivity.class);
            } else {
                if (sizeUser > 0) {
                    intent.setClass(FirstGroupNameActivity.this, SelectPersonalWhoActivity.class);
                }
            }
            if (sizeUser > 0) {
