...
import com.yuefeng.contacts.presenter.SeventhFindOrganPresenter;
...
/*六级组*/
public class SeventhGroupNameActivity extends BaseActivity implements FindOrganUserContract.View {
    //List<OrganlistBean>
    ...
    private SeventhFindOrganPresenter mPresenter;
    ...
    protected void initView(Bundle savedInstanceState) {
        if (!EventBus.getDefault().isRegistered(this)) {
            ...
            mPresenter = new SeventhFindOrganPresenter(this, this);
            initRecyclerView();
    ...
    private void toUserDetailActivity(String id) {
        ...
        intent.setClass(SeventhGroupNameActivity.this, UserDetailInfosActivity.class);
    ...
    private void toActivity(OrganPersonalDataBean bean) {
        ...
        if (bean != null) {
            ...
            if (sizeOrgan > 0) {
                ...
                intent.setClass(SeventhGroupNameActivity.this, FirstGroupNameActivity.class);
            } else {
                if (sizeUser > 0) {
                    intent.setClass(SeventhGroupNameActivity.this, SelectPersonalWhoActivity.class);
                }
            }
            if (sizeUser > 0) {
