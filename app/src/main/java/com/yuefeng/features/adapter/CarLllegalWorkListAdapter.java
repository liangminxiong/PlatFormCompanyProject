...
public class CarLllegalWorkListAdapter extends BaseItemDraggableAdapter<MsgDataBean, BaseViewHolder> {
    ...
    public CarLllegalWorkListAdapter(int layoutResId, @Nullable List<MsgDataBean> data) {
