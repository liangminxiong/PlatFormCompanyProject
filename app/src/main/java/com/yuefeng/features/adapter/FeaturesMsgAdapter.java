...
/*消息*/
public class FeaturesMsgAdapter extends BaseItemDraggableAdapter<MsgDataBean, BaseViewHolder> {
    ...
    public FeaturesMsgAdapter(int layoutResId, @Nullable List<MsgDataBean> data) {
