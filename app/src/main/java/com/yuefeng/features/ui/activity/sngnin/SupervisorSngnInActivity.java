...
/*主管打卡*/
public class SupervisorSngnInActivity extends BaseActivity implements JobAttendanceContract.View {
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.iv_sp_sngnin:
                startActivity(new Intent(SupervisorSngnInActivity.this,SupervisorSngnInActivity.class));
                break;
        }
    }
