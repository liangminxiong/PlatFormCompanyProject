 ...
 */
package com.yuefeng.features.ui.activity.nativ;
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode)
                        bundle.getSerializable(Constans.ROUTE_PLAN_NODE);
            }
        }
...
//        showOverlay();
    ...
    private void showOverlay() {
        ...
        BNItemizedOverlay overlay = new BNItemizedOverlay(
                DemoGuideActivity.this.getResources().getDrawable(R.drawable.navi_guide_turn));
...
//                                new BNRoutePlanNode(BaiduNaviActivity.endLon, BaiduNaviActivity.endLat, BaiduNaviActivity.endAddress, null, CoordinateType.GCJ02));
                    }
                }
            };
        }
