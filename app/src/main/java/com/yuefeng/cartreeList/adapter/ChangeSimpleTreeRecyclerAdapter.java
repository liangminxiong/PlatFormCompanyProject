...
public class ChangeSimpleTreeRecyclerAdapter extends ChangeTreeRecyclerAdapter {
    private int icon_type;

    public ChangeSimpleTreeRecyclerAdapter(RecyclerView mTree, Context context, List<Node> datas,
