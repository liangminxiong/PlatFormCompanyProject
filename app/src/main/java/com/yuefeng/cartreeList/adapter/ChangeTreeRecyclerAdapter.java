 ...
 */
public abstract class ChangeTreeRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public boolean isSetPadding;//是否右移
    /**
     * 展开与关闭的图片
     */
    ...
    public ChangeTreeRecyclerAdapter(RecyclerView mTree, Context context, List<Node> datas,
        ...
        this.isSetPadding = isSetPadding;
        if (datas.size() <= 0) {
            return;
        }
        for (Node node : datas) {
    ...
    public ChangeTreeRecyclerAdapter(RecyclerView mTree, Context context, List<Node> datas,
        ...
        this(mTree, context, datas, defaultExpandLevel, -1, -1, isAllSelect, isSetPadding);
    }
...
//        convertView = getConvertView(node, position, convertView, parent);
        ...
        if (isSetPadding) {
            ...
            view = (ImageView) rootView.findViewById(R.id.iv_icon_type);
